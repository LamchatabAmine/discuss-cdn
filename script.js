...
function createChatButton() {
  ...
  chatButtonImg.src =
    "https://cdn.jsdelivr.net/gh/LamchatabAmine/discuss-cdn/images/discuss.png";
...
function createWelcomeTitle() {
  ...
  WelcomeTitle.innerHTML = `
    <img class="body-module-welcomeIcon" src="https://cdn.jsdelivr.net/gh/LamchatabAmine/discuss-cdn/images/discuss.png" alt="Discuss">
...
function createWelcomeIntro() {
  ...
  WelcomeIntro.textContent =
    "Lorem ipsum dolor sit amet consectetu adipisicing elit. Maiores sit beatae provident explicabo earum error";
...
function createCommentUsers() {
  ...
  <div class="direct-chat-infos clearfix">
    <span class="direct-chat-name float-left">Amine Lamchatab</span>
    <span class="direct-chat-timestamp float-right">23 Jan 2:00 pm</span>
    </div>
      <img class="direct-chat-img" src="https://cdn.jsdelivr.net/gh/LamchatabAmine/discuss-cdn/images/avatar.png" alt="message user image">
...
function createConversationPanel() {
  ...
  const conversationPanelContainer = document.createElement("form");
